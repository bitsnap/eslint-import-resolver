...
var _=require("lodash-magic-cache").lodashFP(["flow","get","filter","isArray","find","first","nth","defaults","isEmpty","fromPairs","uniq","concat","toPairs","flatMap","identity","map","keys","compact"]);var defaultValidExtensions=[".js",".mjs",".json",".jsx"];var settings={},dependencies={},moduleResolverSettings=_.flow(_.get("plugins"),_.filter(_.isArray),_.find(function(a){return"module-resolver"===_.first(a)}),_.nth(1),_.defaults({root:[],alias:[]})),resolverSettings=_.flow(_.get("plugins"),_.filter(_.isArray),_.find(function(a){return"resolver"===_.first(a)}),_.nth(1),_.defaults({resolveDirs:[]}),function(a){return{root:a.resolveDirs,alias:{}}});var readSettings=function(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:".";if(_.isEmpty(settings)){var b;try{b=JSON.parse(fs.readFileSync("".concat(a,"/.babelrc"),{encoding:"utf8"}).toString());}catch(a){b={};}var c=moduleResolverSettings(b),d=resolverSettings(b);settings=_.fromPairs([["root",_.uniq(_.concat(_.get("root")(d),_.get("root")(c)))],["alias",_.fromPairs(_.concat(_.toPairs(_.get("alias")(d)),_.toPairs(_.get("alias")(c))))]]);}return _.defaults({root:[],alias:[]})(settings)};var readDependencies=function(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:".";if(_.isEmpty(dependencies)){var b;try{b=JSON.parse(fs.readFileSync("".concat(a,"/package.json"),{encoding:"utf8"}).toString());}catch(a){b={};}dependencies=_.flow(function(a){return _.flatMap(_.identity)(_.map(function(b){return _.keys(_.get(b)(a))})(["dependencies","peerDependencies","devDependencies"]))},_.uniq,_.compact)(b);}return dependencies};

...
var _$3=require("lodash-magic-cache").lodashFP(["isEmpty","flow","defaults","get","reduce","replace","entries","find","isString","startsWith","map","compact","nth"]);var resolve=function(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};if(_$3.isEmpty(a)||!a)return{found:!1};if(isCore(a))return{found:!0};var d=_$3.flow(_$3.defaults({root:process.cwd()}),_$3.get("root"))(c),e=readSettings(d,c),g="".concat(a);g=_$3.reduce(function(a,b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return _$3.flow(_$3.replace(new RegExp("^".concat(d)),e),_$3.replace(new RegExp("".concat(d,"$")),e))(a)})(g)(_$3.entries(e.alias));var h=_$3.flow(_$3.defaults({extensions:defaultValidExtensions}),_$3.get("extensions"))(c),i=_$3.replace(/$.\//,"")(g),j=path.join(path.dirname(b),i),k=exists(j,h);if(k)return{found:!0,path:k};if(_$3.find(function(b){return _$3.isString(b)?_$3.startsWith(b)(a):a.match(b)})(e.externals))return{found:!0};var f=_$3.map(function(a){return path.join(d,a,g)})(e.root);if(k=_$3.flow(_$3.map(function(a){return exists(a,h)}),_$3.compact,_$3.nth(0))(f), k)return{found:!0,path:k};var l=readDependencies(d);return _$3.find(function(b){return _$3.startsWith(b)(a)})(l)&&(k=exists(path.join(d,"node_modules",a),h), k)?{found:!0,path:k}:{found:!1}};
